...
module ArtisansUi
  module Accordion
    # Accordion with Chevron icon (Variant 1)
    # Classic accordion with rotating chevron icon
    # Exact RailsBlocks implementation
    #
    # @example
    #   <%= render ArtisansUi::Accordion::ChevronComponent.new(items: [
    #     { question: "Question 1", answer: "Answer 1" },
    #     { question: "Question 2", answer: "Answer 2" }
    #   ]) %>
    class ChevronComponent < ApplicationViewComponent
