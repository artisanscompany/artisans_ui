...
module ArtisansUi
  module Accordion
    # Styled Accordion with Floating Answer (Variant 5)
    # Accordion with styled background and floating answer box
    # Exact RailsBlocks implementation
    #
    # @example
    #   <%= render ArtisansUi::Accordion::StyledFloatingComponent.new(items: [
    #     { question: "Question 1", answer: "Answer 1" },
    #     { question: "Question 2", answer: "Answer 2" }
    #   ]) %>
    class StyledFloatingComponent < ApplicationViewComponent
