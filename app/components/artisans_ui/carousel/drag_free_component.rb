...
module ArtisansUi
  module Carousel
    # Drag Free Carousel Component (Variant 3)
    # Free-scrolling carousel with drag momentum
    # Exact RailsBlocks implementation
    #
    # @example
    #   <%= render ArtisansUi::Carousel::DragFreeComponent.new(
    #     slides: [
    ...
    #     ]
    #   ) %>
    class DragFreeComponent < ApplicationViewComponent
