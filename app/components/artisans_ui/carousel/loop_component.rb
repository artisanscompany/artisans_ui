...
module ArtisansUi
  module Carousel
    # Loop Carousel Component (Variant 2)
    # Infinite looping carousel with seamless transitions
    # Exact RailsBlocks implementation
    #
    # @example
    #   <%= render ArtisansUi::Carousel::LoopComponent.new(
    #     slides: [
    ...
    #     ]
    #   ) %>
    class LoopComponent < ApplicationViewComponent
