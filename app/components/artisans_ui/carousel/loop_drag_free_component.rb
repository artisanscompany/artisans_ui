...
module ArtisansUi
  module Carousel
    # Loop & Drag Free Carousel Component (Variant 4)
    # Combines infinite looping with free-scrolling drag
    # Exact RailsBlocks implementation
    #
    # @example
    #   <%= render ArtisansUi::Carousel::LoopDragFreeComponent.new(
    #     slides: [
    ...
    #     ]
    #   ) %>
    class LoopDragFreeComponent < ApplicationViewComponent
