...
module ArtisansUi
  module Carousel
    # Variable Widths Carousel Component (Variant 5)
    # Carousel with slides of different widths
    # Exact RailsBlocks implementation
    #
    # @example
    #   <%= render ArtisansUi::Carousel::VariableWidthsComponent.new(
    #     slides: [
    ...
    #     ]
    #   ) %>
    class VariableWidthsComponent < ApplicationViewComponent
          ...
          **@html_options
          ...
          tag.div(
            ...
            data: {
              ...
              "artisans-ui--carousel-drag-free-value": true,
              "artisans-ui--carousel-wheel-gestures-value": true,
      ...
      def render_slide(slide)
        tag.div(
          class: "flex min-w-0 shrink-0 grow-0 #{slide[:width] || 'basis-1/3'} items-center justify-center pl-4"
        ) do
          tag.img(
            src: slide[:image_url],
            alt: slide[:alt],
