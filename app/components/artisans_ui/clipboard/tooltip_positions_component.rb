...
module ArtisansUi
  module Clipboard
    # Clipboard button with configurable tooltip positions
    # Demonstrates all 12 available tooltip positions
    # Exact RailsBlocks implementation
    #
    # @example
    #   <%= render ArtisansUi::Clipboard::TooltipPositionsComponent.new(
    #     text: "Top tooltip!",
    #     placement: "top",
    #     success_message: "Top tooltip shown!"
    #   ) do %>
    #     top
    #   <% end %>
    class TooltipPositionsComponent < ApplicationViewComponent
      def initialize(text:, placement: "top", success_message: "Copied!", **html_options)
        @text = text
        @placement = placement
      ...
      def call
        tag.button(
          ...
          data: {
            ...
            clipboard_text: @text,
            clipboard_tooltip_placement_value: @placement,
