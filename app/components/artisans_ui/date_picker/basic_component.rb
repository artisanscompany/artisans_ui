...
module ArtisansUi
  module DatePicker
    # Basic Date Picker Component (Variant 1)
    # Simple date picker with optional today and clear buttons
    # Requires AirDatepicker and Floating UI JavaScript libraries
    ...
    class BasicComponent < ApplicationViewComponent
      def initialize(show_today_button: false, show_clear_button: false, placeholder: "Select date...", **html_options)
