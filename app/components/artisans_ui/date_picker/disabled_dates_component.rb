...
module ArtisansUi
  module DatePicker
    # Disabled Dates Component (Variant 6)
    class DisabledDatesComponent < ApplicationViewComponent
      def initialize(disabled_dates: [], show_today_button: false, show_clear_button: false, placeholder: "Select date...", **html_options)
      ...
      def call
        tag.div(data: { controller: "date-picker", date_picker_disabled_dates_value: @disabled_dates.to_json, date_picker_show_today_button_value: @show_today_button, date_picker_show_clear_button_value: @show_clear_button }, class: "relative w-full max-w-sm") do
          safe_join([
