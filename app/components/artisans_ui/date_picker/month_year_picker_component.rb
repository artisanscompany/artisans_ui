...
module ArtisansUi
  module DatePicker
    # Month/Year Picker Component (Variant 8)
    class MonthYearPickerComponent < ApplicationViewComponent
      def initialize(view: "months", show_today_button: false, show_clear_button: false, placeholder: "Select month...", **html_options)
        @view = view
      ...
      def call
        tag.div(data: { controller: "date-picker", date_picker_start_view_value: @view, date_picker_min_view_value: @view, date_picker_show_today_button_value: @show_today_button, date_picker_show_clear_button_value: @show_clear_button }, class: "relative w-full max-w-sm") do
          safe_join([
            tag.input(class: "block w-full rounded-lg border-0 px-3 py-2 text-neutral-900 shadow-sm ring-1 ring-inset ring-neutral-300 placeholder:text-neutral-500 focus:ring-2 focus:ring-neutral-600 outline-hidden leading-6 text-base sm:text-sm", readonly: true, data: { date_picker_target: "input" }, placeholder: @placeholder, **@html_options),
