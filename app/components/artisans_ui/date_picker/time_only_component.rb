...
module ArtisansUi
  module DatePicker
    # Time Only Picker Component (Variant 9)
    class TimeOnlyComponent < ApplicationViewComponent
      def initialize(show_today_button: false, show_clear_button: false, placeholder: "Select time...", **html_options)
      ...
      def call
        tag.div(data: { controller: "date-picker", date_picker_time_only_value: true, date_picker_show_today_button_value: @show_today_button, date_picker_show_clear_button_value: @show_clear_button }, class: "relative w-full max-w-sm") do
          safe_join([
