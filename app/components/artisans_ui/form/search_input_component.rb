  ...
  module Form
    ...
    class SearchInputComponent < ApplicationViewComponent
      ...
      def input_with_icon_classes
        "w-full pl-11 pr-4 py-2.5 text-sm border border-neutral-200 rounded-lg bg-white text-neutral-900 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-neutral-300 focus:border-transparent transition-colors"
      end
    end
  end
end
