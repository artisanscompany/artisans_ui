...
module ArtisansUi
  module Form
    ...
    class SelectComponent < ApplicationViewComponent
      ...
      def default_classes
        "w-full px-4 py-2.5 text-sm border border-neutral-300 rounded-lg bg-white text-neutral-900 focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:border-transparent transition-colors"
      end
    end
  end
end
