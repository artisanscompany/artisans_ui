    ...
    class SwitchFieldComponent < ApplicationViewComponent
      ...
      def render_label
        tag.label(
          @label,
          for: field_id,
          class: "text-sm text-neutral-900 dark:text-white cursor-pointer"
        )
      end
      ...
      def toggle_element
        tag.div(class: "absolute top-[3px] left-[3px] w-[18px] h-[18px] bg-white rounded-full shadow-sm transition-all duration-150 ease-in-out peer-checked:translate-x-4 flex items-center justify-center dark:bg-neutral-200 dark:peer-checked:bg-neutral-800 pointer-events-none")
      end
