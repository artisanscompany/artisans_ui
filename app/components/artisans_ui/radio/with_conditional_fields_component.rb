  ...
  module Radio
    ...
    class WithConditionalFieldsComponent < ApplicationViewComponent
      ...
      def credit_card_fields
        tag.div(
          class: "mt-4 p-4 border border-neutral-200 rounded-lg",
          data: {
          ...
          safe_join([
            tag.label("Card Number", class: "block text-sm font-medium text-neutral-700 mb-1"),
            tag.input(
              type: "text",
            ...
            tag.div(class: "grid grid-cols-2 gap-4 mt-3") do
              safe_join([
                tag.div do
                  safe_join([
                    tag.label("Expiry", class: "block text-sm font-medium text-neutral-700 mb-1"),
                    tag.input(
                      type: "text",
                      placeholder: "MM/YY",
                      class: "w-full px-3 py-2 border border-neutral-300 rounded-md"
                ...
                tag.div do
                  safe_join([
                    tag.label("CVV", class: "block text-sm font-medium text-neutral-700 mb-1"),
                    tag.input(
                      type: "text",
                      placeholder: "123",
                      class: "w-full px-3 py-2 border border-neutral-300 rounded-md"
      ...
      def paypal_fields
        tag.div(
          class: "hidden mt-4 p-4 border border-neutral-200 rounded-lg",
          data: {
            "artisans-ui--conditional-radio-target": "conditionalField",
          ...
          safe_join([
            tag.label("PayPal Email", class: "block text-sm font-medium text-neutral-700 mb-1"),
            tag.input(
              type: "email",
      ...
      def bank_transfer_fields
        tag.div(
          ...
          safe_join([
            tag.label("Account Number", class: "block text-sm font-medium text-neutral-700 mb-1"),
            tag.input(
              type: "text",
            ...
            tag.div(class: "mt-3") do
              safe_join([
                tag.label("Routing Number", class: "block text-sm font-medium text-neutral-700 mb-1"),
                tag.input(
                  type: "text",
