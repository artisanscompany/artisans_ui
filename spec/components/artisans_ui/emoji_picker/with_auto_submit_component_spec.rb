...
RSpec.describe ArtisansUi::EmojiPicker::WithAutoSubmitComponent, type: :component do
  ...
  it "renders with auto-submit enabled" do
    render_inline(described_class.new(name: "emoji"))

    expect(rendered_content).to include('data-artisans-ui--emoji-picker-auto-submit-value="true"')
  end
