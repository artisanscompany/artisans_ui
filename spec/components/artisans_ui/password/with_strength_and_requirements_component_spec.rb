...
RSpec.describe ArtisansUi::Password::WithStrengthAndRequirementsComponent, type: :component do
  it "renders password input with both strength and requirements features" do
  ...
  it "renders dual SVG icons for each requirement plus toggle icon" do
    render_inline(described_class.new)
